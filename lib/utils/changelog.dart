    ...
    itemList.add(
      ChangeLogItem()
        ...
        ..features = [
          ...
          "Added option to copy required cash in Foreign Stocks",
          "Travel notifications and live updates can now open Foreign Stocks instead of the browser",
    ...
    itemList.add(
      ChangeLogItem()
        ...
        ..features = [
          ...
          "Fixed issues when sorting targets",
